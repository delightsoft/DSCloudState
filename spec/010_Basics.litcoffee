...
CloudState - позволяет орагнизовать синхронизацию состояний между несколькими узлами (сервера, браузерами), используя
...
в самам *конце описания* нового класса, необходимо вызвать статический метод makeOriginAndClone()
